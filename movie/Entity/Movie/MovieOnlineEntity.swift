...
// MARK: - MovieOnlineModel
struct MovieOnlineEntity: Codable {
    let adult: Bool
...
extension MovieOnlineEntity{
    func toMovieModel() -> MovieEntity {
        ...
        return MovieEntity(adult: self.adult,
