...
struct MovieDetailOnlineEntity: Codable {
    let adult: Bool
...
extension MovieDetailOnlineEntity {
    func toMovieDetailEntity() -> MovieDetailEntity {
        ...
        return MovieDetailEntity(adult: self.adult,
